...
use super::super::widgets::{
    field_hint, settings_bays, settings_field_label, settings_input_with_reset, SettingsBay,
    SettingsToggleRow,
};
                            ...
                            enabled,
                            {
                                ...
                                move |on, window, cx| {
                                    app.update(cx, |this, cx| {
                                        this.set_draft_multi_connection_enabled(on, window, cx);
                                    });
                                }
                            },
                        )
                        .hint("Use parallel Range requests for large files."),
                    )
